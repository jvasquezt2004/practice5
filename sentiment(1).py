...
# Filter out neutral sentiment using pandas query method
train = train.query("sentiment != 'Neutral'")
test = test.query("sentiment != 'Neutral'")

# Alternative method using pandas filtering
# train = train[~train['sentiment'].isin(['Neutral'])]
# test = test[~test['sentiment'].isin(['Neutral'])]
